...
const AppHeader = props => {
    let { menuClick, avatar, menuToggle, loginOut, profileChange } = props



    const menu = (
        <Menu>
            <Menu.ItemGroup title={"User: " + localStorage.getItem("userName")}>
            {/*    <Menu.Divider />*/}
            {/*    <Menu.Item>*/}
            {/*        <Icon type='edit' />*/}
            {/*        个人设置*/}
            ...
            {/*        <span>*/}
            {/*            <Icon type='setting' />*/}
            {/*            <a href="#/profileChange">Profile Change</a>*/}
            {/*        </span>*/}
            {/*    </Menu.Item>*/}
                <Menu.Item>
                <span onClick={profileChange}>
                    <Icon type='setting' /> Profile Change
                </span>
                </Menu.Item>
                <Menu.Item>
