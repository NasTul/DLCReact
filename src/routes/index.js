...
// Register
const RegisterView = loadable(() => import('../views/Register/Register'))

// Report
const ReportView = loadable( () => import('../views/ReportView/Report'))
...
const ProfileChangeView = loadable(() => import(/* webpackChunkName: 'ProfileChange' */ '../views/ProfileChange/ProfileChange'))
const AboutView = loadable(() => import(/* webpackChunkName: 'About' */ '../views/About/About'))
const uploadResultView = loadable(() => import(/* webpackChunkName: 'scanResult' */ '../views/uploadResult/uploadResult'))
...
const routes = [
    ...
    { path: '/profileChange', exact: false, name: '关于', component: ProfileChangeView, auth: [1] },
    { path: '/register', exact: false, name:'Register', component: RegisterView, auth: [1]},
    { path: '/about', exact: false, name:'About', component: AboutView, auth: [1]},
    { path: '/report', exact: false, name: 'Report', component: ReportView, auth: [1]},
    { path: '/scanResult', exact: false, name: 'Scan Result', component: uploadResultView, auth: [1]}
]
